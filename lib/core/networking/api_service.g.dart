...
class _ApiService implements ApiService {
  ...
  @override
  Future<MovieResponseBody> getPopularMovies(String authorization) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': authorization};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MovieResponseBody>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late MovieResponseBody _value;
    try {
      _value = MovieResponseBody.fromJson(_result.data!);
    } on Object catch (e, s) {
